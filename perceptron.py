...
if __name__=="__main__":
    ...
    parser = argparse.ArgumentParser(description="A simple program to train a perceptron")
    ...
    perceptron = Perceptron(training_data[0].shape[1])
    w, b = perceptron.train(training_data, args.lrate)
    o, r = perceptron.evaluate(testing_data)
